...
class Quantity:
    ...
    def distribute_by_ratio(
        self, ratios: List[Union[int, float, Decimal]]
    ) -> List["Quantity"]:
    ...
    @classmethod
    def from_fraction(
        cls, numerator: int, denominator: int, allow_negative: bool = False
    ) -> "Quantity":
    ...
    @classmethod
    def sum(
        cls, quantities: List["Quantity"], allow_negative: bool = False
    ) -> "Quantity":
