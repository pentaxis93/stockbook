...
class PortfolioMetrics:
    ...
    def is_well_diversified(self) -> bool:
        ...
        return (
            self.position_count >= 5 and
            self.diversity_score >= Decimal('0.6') and
            not any(pos.is_overweight for pos in self.position_allocations)
        )
