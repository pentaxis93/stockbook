...
class CalculationError(DomainServiceError):
    ...
    def __init__(self, message: str, calculation_type: str, input_data: Optional[dict] = None):
        self.calculation_type = calculation_type
        self.input_data = input_data or {}
        super().__init__(message, {"calculation_type": calculation_type, "input_data": input_data})


class InsufficientDataError(DomainServiceError):
    """Raised when insufficient data is available for analysis or calculations."""
    
    def __init__(self, message: str, required_data: List[str], available_data: Optional[List[str]] = None):
        self.required_data = required_data
        self.available_data = available_data or []
        super().__init__(message, {"required": required_data, "available": available_data})


class PricingError(DomainServiceError):
    """Raised when price-related calculations or validations fail."""
    
    def __init__(self, message: str, symbol: Optional[str] = None, price_value: Optional[str] = None):
        self.symbol = symbol
...
class RiskAnalysisError(DomainServiceError):
    ...
    def __init__(self, message: str, risk_type: Optional[str] = None, analysis_context: Optional[dict] = None):
