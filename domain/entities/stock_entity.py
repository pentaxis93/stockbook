...
class StockEntity:
    ...
    def __repr__(self) -> str:
        ...
        return (f"StockEntity(symbol={self.symbol!r}, name={self.name!r}, "
    ...
    def _validate_name(cls, name: str) -> None:
        ...
        if len(name) > cls.MAX_NAME_LENGTH:
            raise ValueError(f"Company name cannot exceed {cls.MAX_NAME_LENGTH} characters")
    ...
    def _validate_industry_group(cls, industry_group: Optional[str]) -> None:
        ...
        if industry_group is not None and len(industry_group) > cls.MAX_INDUSTRY_LENGTH:
            raise ValueError(f"Industry group cannot exceed {cls.MAX_INDUSTRY_LENGTH} characters")
