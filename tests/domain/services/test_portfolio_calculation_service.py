...
from domain.services.value_objects.portfolio_metrics import PortfolioMetrics, PortfolioAllocation
...
class TestPortfolioValueCalculations:
    ...
    def test_calculate_position_values(self):
        ...
        position_value = service.calculate_position_value(stock, quantity, current_price)
