...
# Test data helper
def create_test_stock(symbol="AAPL", name="Apple Inc.", current_price=150.00, grade="A"):
...
class TestStockDataIntegrityService:
    ...
    def test_validate_stock_data_completeness(self):
        ...
        incomplete_stock_name._name = ""  # Access internal attribute to bypass constructor validation
        ...
        incomplete_stock_grade._grade = ""  # Access internal attribute to bypass constructor validation
