...
class TestStockApplicationService:
    ...
    def test_get_stock_by_symbol_success(self):
        ...
        self.mock_stock_repository.get_by_symbol.assert_called_once_with(StockSymbol("AAPL"))
    ...
    def test_get_stock_by_symbol_not_found(self):
        ...
        # Verify repository interaction
        self.mock_stock_repository.get_by_symbol.assert_called_once_with(StockSymbol("NFND"))
    ...
    def test_stock_exists_true(self):
        ...
        # Verify repository interaction
        self.mock_stock_repository.exists_by_symbol.assert_called_once_with(StockSymbol("AAPL"))
    ...
    def test_stock_exists_false(self):
        ...
        # Verify repository interaction
        self.mock_stock_repository.exists_by_symbol.assert_called_once_with(StockSymbol("NFND"))