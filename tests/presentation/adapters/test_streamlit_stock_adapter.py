...
from presentation.view_models.stock_view_models import (
    ...
    CreateStockResponse, ValidationErrorResponse, StockViewModel
)
...
class TestStreamlitStockAdapter:
    ...
    def test_render_create_stock_form_successful_submission(
        self, mock_success, mock_submit, mock_text_area, mock_selectbox, mock_text_input, mock_form
    ):
    ...
    def test_render_create_stock_form_validation_error(
        self, mock_error, mock_submit, mock_text_area, mock_selectbox, mock_text_input, mock_form
    ):
        ...
        mock_text_input.side_effect = ["", "Apple Inc.", "Technology", ""]  # Empty symbol
        mock_selectbox.return_value = "A"
    ...
    def test_render_stock_detail_success(self, mock_write, mock_metric, mock_columns, mock_header):
    ...
    @patch('streamlit.selectbox')
    @patch('streamlit.button')
    def test_render_grade_filter_widget(self, mock_button, mock_selectbox, mock_columns):
    ...
    def test_render_stock_dataframe_formatting(self, mock_dataframe):
        ...
        # Arrange
        stocks = [
            StockViewModel(id=1, symbol="AAPL", name="Apple Inc.", grade="A", industry_group="Technology"),
            StockViewModel(id=2, symbol="GOOGL", name="Alphabet Inc.", grade="A", industry_group="Technology")
        ]
    ...
    def test_adapter_page_refresh_after_successful_create(self, mock_rerun):
        ...
        # Arrange
        success_response = CreateStockResponse.success(1, "AAPL", "Created successfully")
    ...
    def test_adapter_data_type_conversion(self):
        ...
        # Arrange
        stocks = [
            StockViewModel(id=1, symbol="AAPL", name="Apple Inc.", grade=None),  # None grade
            StockViewModel(id=2, symbol="GOOGL", name="Alphabet Inc.", grade="A")
        ]
