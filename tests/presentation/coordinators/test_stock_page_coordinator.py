...
class TestStockPageCoordinator:
    ...
    def test_render_stock_dashboard_metrics(self, mock_columns, mock_header):
        ...
        assert mock_col1.metric.called or mock_col2.metric.called or mock_col3.metric.called
    ...
    def test_render_stock_management_page_navigation(self, mock_sidebar):
        ...
        self.mock_adapter.render_stock_list.return_value = StockListResponse.success([], "No stocks")
    ...
    def test_handle_successful_stock_creation(self, mock_balloons, mock_success):
        ...
        # Arrange
        success_response = CreateStockResponse.success(1, "AAPL", "Stock created successfully")
