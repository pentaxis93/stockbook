...
class TestTransactionRepositoryCreate:
    ...
    def test_create_transaction_returns_id(self, transaction_repository, sample_transaction):
...
class TestTransactionRepositoryRead:
    ...
    def test_get_by_id_existing_transaction(self, transaction_repository, sample_transaction):
        ...
        assert retrieved_transaction.transaction_type == sample_transaction.transaction_type
    ...
    def test_get_by_portfolio_with_transactions(self, transaction_repository):
        ...
        transaction1 = TransactionEntity(
            portfolio_id=1, stock_id=1, transaction_type="buy",
            quantity=Quantity(100), price=Money(Decimal("50.00"), "USD"),
            transaction_date=date(2024, 1, 1)
        )
        transaction2 = TransactionEntity(
            portfolio_id=1, stock_id=1, transaction_type="sell",
            quantity=Quantity(50), price=Money(Decimal("55.00"), "USD"),
            transaction_date=date(2024, 1, 15)
        )
    ...
    def test_get_by_portfolio_with_limit(self, transaction_repository):
        ...
        for i in range(5):
            transaction = TransactionEntity(
                portfolio_id=1, stock_id=1, transaction_type="buy",
                quantity=Quantity(10), price=Money(Decimal("50.00"), "USD"),
    ...
    def test_get_by_stock_with_portfolio_filter(self, transaction_repository):
        ...
        unfiltered_transactions = transaction_repository.get_by_stock(1, portfolio_id=999)
    ...
    def test_get_by_date_range(self, transaction_repository):
        ...
        late_transaction = TransactionEntity(
            portfolio_id=1, stock_id=1, transaction_type="buy",
            quantity=Quantity(25), price=Money(Decimal("60.00"), "USD"),
            transaction_date=date(2024, 2, 1)
        )
...
class TestTransactionRepositoryUpdate:
    ...
    def test_update_existing_transaction(self, transaction_repository, sample_transaction):
...
class TestTransactionRepositoryDelete:
    ...
    def test_delete_existing_transaction(self, transaction_repository, sample_transaction):
...
class TestTransactionRepositoryIntegration:
    ...
    def test_full_transaction_lifecycle(self, transaction_repository):
        ...
        update_result = transaction_repository.update(transaction_id, updated_transaction)
