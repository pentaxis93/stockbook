...
class TestPortfolioRepositoryCreate:
    ...
    def test_create_portfolio_with_all_fields(self, portfolio_repository, sample_portfolio):
        ...
        assert created_portfolio.created_date is not None  # Database sets this automatically
...
class TestPortfolioRepositoryDeactivate:
    ...
    def test_deactivate_existing_portfolio(self, portfolio_repository, sample_portfolio):
