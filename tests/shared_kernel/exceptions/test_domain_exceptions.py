...
class TestDomainServiceError:
    ...
    def test_domain_service_error_with_inner_exception(self):
        ...
        error = DomainServiceError(
            "Domain operation failed", inner_exception=inner_exception
        )
...
class TestValidationError:
    ...
    def test_validation_error_serialization(self):
        ...
        error = ValidationError(
            "Invalid price", field="price", value=-100, severity="error"
        )
...
class TestBusinessRuleViolationError:
    ...
    def test_business_rule_severity(self):
        ...
        blocking = BusinessRuleViolationError(
            "Insufficient funds", rule_name="account_balance_check", severity="blocking"
        )
...
class TestAnalysisError:
    ...
    def test_create_analysis_error(self):
        ...
        assert (
            error.message == "Risk analysis failed due to insufficient correlation data"
        )
...
class TestExceptionUtilities:
    ...
    def test_error_aggregation(self):
        ...
        aggregated = DomainServiceError.aggregate_errors(
            "Multiple domain errors occurred", errors
        )
    ...
    def test_error_severity_comparison(self):
        ...
        critical = BusinessRuleViolationError(
            "Critical", rule_name="test", severity="critical"
        )
