    ...
    def _get_business_logic_message(self, error: BusinessLogicError) -> str:
        ...
        if "risk" in rule.lower():
            if current_value and limit_value:
                return (f"Risk limit exceeded: {current_value}% is above the "
            ...
            return "You have reached the maximum number of positions for this portfolio."
    ...
    def _get_business_logic_suggestions(self, error: BusinessLogicError) -> List[str]:
        ...
        if "risk" in rule:
            ...
            if current_value and limit_value:
                ...
                suggestions.append(f"Try reducing to approximately {suggested_quantity}% of current quantity")
