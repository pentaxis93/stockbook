...
from domain.repositories.interfaces import (
    ...
    ITransactionRepository, ITargetRepository, 
    IPortfolioBalanceRepository, IJournalRepository
)
...
class TransactionalDatabaseConnection:
    ...
    def __init__(self, connection: sqlite3.Connection, original_db_connection: DatabaseConnection):
        """
    ...
    def stocks(self) -> IStockRepository:
        ...
        if self._stocks is None:
            if self._connection is None:
                ...
                connection_wrapper = TransactionalDatabaseConnection(self._connection, self.db_connection)
