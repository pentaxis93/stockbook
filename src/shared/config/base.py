"""Base configuration utilities and exceptions.

This module provides the foundation for all configuration modules,
including common exceptions and environment variable helpers.
"""
