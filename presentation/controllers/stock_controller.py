...
from presentation.view_models.stock_view_models import (
    CreateStockRequest, UpdateStockRequest, StockViewModel,
    StockListResponse, StockDetailResponse, CreateStockResponse,
    UpdateStockResponse, ValidationErrorResponse, StockSearchRequest
)
...
class StockController:
    ...
    def get_stock_list(self) -> StockListResponse:
        ...
        try:
            ...
            return StockListResponse.success(
                stock_view_models,
                f"Retrieved {len(stock_view_models)} stocks"
            )
    ...
    def get_stock_by_symbol(self, symbol: str) -> Union[StockDetailResponse, ValidationErrorResponse]:
        """
        ...
        try:
            ...
            if not stock_dto:
                return StockDetailResponse.error(f"Stock with symbol {normalized_symbol} not found")
    ...
    def get_stocks_by_grade(self, grade: str) -> Union[StockListResponse, ValidationErrorResponse]:
        """
    ...
    def update_stock(self, request: UpdateStockRequest) -> Union[UpdateStockResponse, ValidationErrorResponse]:
        """
    ...
    def search_stocks(self, search_request: StockSearchRequest) -> Union[StockListResponse, ValidationErrorResponse]:
        """
