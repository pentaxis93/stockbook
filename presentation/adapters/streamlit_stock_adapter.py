...
class StreamlitStockAdapter:
    ...
    def render_create_stock_form(self, refresh_on_success: bool = False) -> Optional[CreateStockResponse]:
        """
    ...
    def render_stock_list(self, show_metrics: bool = True) -> Optional[StockListResponse]:
        """
    ...
    def render_stock_filters(self) -> Optional[StockSearchRequest]:
        ...
        try:
            ...
            with col1:
                symbol_filter = st.text_input("Symbol contains", placeholder="e.g., APP")
    ...
    def _prepare_display_data(self, stocks: List[StockViewModel]) -> List[Dict[str, Any]]:
