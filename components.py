...
class DatePicker:
    ...
    def render(self) -> Optional[date]:
        ...
        if self.business_days_only and selected_date.weekday() >= 5:  # Saturday=5, Sunday=6
...
class MessageDisplay:
    ...
    def success(self, message: str, icon: Optional[str] = None, auto_dismiss: Optional[float] = None) -> None:
    ...
    def info(self, message: str, icon: Optional[str] = None, auto_dismiss: Optional[float] = None) -> None:
    ...
    def warning(self, message: str, icon: Optional[str] = None, auto_dismiss: Optional[float] = None) -> None:
