...
class RegistrationInfo:
    ...
    def __init__(self, service_type: Type, implementation_type: Type, lifetime: Lifetime):
...
class DIContainer:
    ...
    def register_singleton(self, service_type: Type[T], implementation_type: Type[T] = None) -> None:
        """
    ...
    def register_transient(self, service_type: Type[T], implementation_type: Type[T] = None) -> None:
        """
    ...
    def _validate_registration(self, service_type: Type, implementation_type: Type) -> None:
        ...
        for param_name, param in sig.parameters.items():
            ...
            if isinstance(param_type, str):
                ...
                def create_string_resolver(type_name):
                    ...
                    return resolver
                dependency_provider = providers.Callable(create_string_resolver(param_type))
            else:
                # Normal type annotation
                dependency_provider = providers.Callable(lambda dep_type=param_type: self.resolve(dep_type))
